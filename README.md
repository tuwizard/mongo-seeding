...
1. Define documents for MongoDB import in JSON, JavaScript or TypeScript file(s). To learn, how to do that, read the **[import data definition](./docs/import-data-definition.md)** document. To see some examples, navigate to the **[`examples`](./examples)** directory.
